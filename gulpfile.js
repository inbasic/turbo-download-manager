...
gulp.task('electron-packager', function () {
  ...
  .pipe(shell([
    'npm install',
    `electron-packager . "Turbo Download Manager" --app-version=${config.version} --platform=darwin --arch=x64 --version=1.3.4 --icon ../../packed/mac.icns`,
    'mv "Turbo Download Manager-darwin-x64" tdm-darwin-x64',
    '7z a -mx9 -r tdm-darwin-x64.7z tdm-darwin-x64/*',
    'mv tdm-darwin-x64.7z ../..',
    'rm -r tdm-darwin-x64/',
    `electron-packager . "Turbo Download Manager" --app-version=${config.version} --platform=win32 --arch=x64 --version=1.3.4 --icon ../../packed/windows.ico`,
    'mv "Turbo Download Manager-win32-x64" tdm-win32-x64',
    '7z a -mx9 -r tdm-win32-x64.7z tdm-win32-x64/*',
    'mv tdm-win32-x64.7z ../..',
    'rm -r tdm-win32-x64/',
    `electron-packager . "Turbo Download Manager" --app-version=${config.version} --platform=win32 --arch=ia32 --version=1.3.4 --icon ../../packed/windows.ico`,
    'mv "Turbo Download Manager-win32-ia32" tdm-win32-ia32',
    '7z a -mx9 -r tdm-win32-ia32.7z tdm-win32-ia32/*',
    'mv tdm-win32-ia32.7z ../..',
    'rm -r tdm-win32-ia32/',
    `electron-packager . "Turbo Download Manager" --app-version=${config.version} --platform=linux --arch=x64 --version=1.3.4`,
    'mv "Turbo Download Manager-linux-x64" tdm-linux-x64',
    '7z a -mx9 -r tdm-linux-x64.7z tdm-linux-x64/*',
    'mv tdm-linux-x64.7z ../..',
    'rm -r tdm-linux-x64/',
    `electron-packager . "Turbo Download Manager" --app-version=${config.version} --platform=linux --arch=ia32 --version=1.3.4`,
